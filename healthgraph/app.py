...
routes.extend([
    ...
    Route("/api/patient/{id}/prior-auth-readiness", endpoint=service.api_get_patient_prior_auth_readiness, methods=["GET"]),
    Route("/api/patient/{id}/hcc-gaps", endpoint=service.api_get_patient_hcc_gaps, methods=["GET"]),
    Route("/api/patient/{id}/medication-rec", endpoint=service.api_get_patient_medication_rec, methods=["GET"]),
    ...
    Route("/api/chaos/scenarios", endpoint=service.api_get_chaos_scenarios, methods=["GET"]),
    Route("/api/trials/screen", endpoint=service.api_get_trials_screen, methods=["GET"]),
